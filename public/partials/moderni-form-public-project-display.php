      ...
      <div class="_cont detail-top">
        ...
        <div class="cols">
          ...
          <div class="left-col">
            ...
            <?php require_once MODERNI_FORM_PLUGIN_DIR_PATH . "public/partials/video-player.php"; ?>
          ...
          <div class="right-col">
            ...
            <h1 itemprop="name"><?php the_title(); ?></h1> <!-- Tony Hunfinger T-Shirt New York -->
    ...
    function init(att) {
        ...
        var listeners = {
            '.quick-cart-product-remove': function(el){
                ...
                if (3 == last_removed_variant_count ) {
                    if( count > 1 ) product.classList.add("show-remove-all");
                }
        ...
        cart.addEventListener("click",function(e) {
            ...
            if (listeners.hasOwnProperty(key) ) {
                if( e.target ) {
                    if( e.target.matches(key) ) listeners[key].apply(null, [e.target]);
                }
            }
        });
